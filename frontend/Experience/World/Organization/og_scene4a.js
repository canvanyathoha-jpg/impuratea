...
export default class OrganizationScene4A {
                    ...
                    setTimeout(() => {
                        try {
                            ...
                            if (this.enableAdvancedAtmosphere) {
                                ...
                                console.log("[OrgScene4A] Skipping advanced atmospheric effects for low-end device");
                            }

                            if (this.enablePostProcessing) {
                                this.setupPostProcessing();
                            } else {
                                console.log("[OrgScene4A] Skipping post-processing composer for low-end device");
                                this.composer = null;
                            }
    ...
    setupMobileLighting() {
        console.log("[OrgScene4A] Applying lightweight lighting for low-end profile...");
    ...
    setupPostProcessing() {
        if (!this.enablePostProcessing) {
            console.log("[OrgScene4A] Post-processing skipped for current performance profile");
            this.composer = null;
            return;
        }
    ...
    setupAtmosphericEffects() {
        if (!this.enableAdvancedAtmosphere) {
            console.log("[OrgScene4A] Advanced atmospheric effects disabled for this device");
