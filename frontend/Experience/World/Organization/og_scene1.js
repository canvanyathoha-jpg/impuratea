...
export default class Organization {
        ...
        return new Promise((resolve, reject) => {
            try {
                ...
                this.setWorldAsync(() => {
                    ...
                    console.log("[OrgScene1] Step 2: Setting up lighting...");
    ...
    setupMobileLighting() {
        console.log("[OrgScene1] Applying lightweight lighting setup for low-end profile...");
    ...
    setupPostProcessing() {
        if (!this.enablePostProcessing) {
            console.log("[OrgScene1] Post-processing skipped for current performance profile");
            this.composer = null;
            return;
        }
    ...
    setupAtmosphericEffects() {
        if (!this.enableAdvancedAtmosphere) {
            console.log("[OrgScene1] Advanced atmospheric effects disabled for this device");
            this.scene.fog = new THREE.Fog(0x12121c, 45, 180);
            return;
        }
